...
#-------------------------------------------------------------------------------
        ...
        #self.dockwidget.catalogLine.setStyleSheet("color: rgb(137, 206, 0)")
...
#-------------------------------------------------------------------------------
    ...
    def tr(self, message):
        #QMessageBox.warning( self.iface.mainWindow(),"Komunikat", u"<b>tr</b>")
    ...
    def add_action(
        ...
        #QMessageBox.warning( self.iface.mainWindow(),"Komunikat", u"<b>add_action</b>")

        return action


    def initGui(self):
        #QMessageBox.warning( self.iface.mainWindow(),"Komunikat", u"<b>initGui</b>")
    ...
    def onClosePlugin(self):
        #QMessageBox.warning( self.iface.mainWindow(),"Komunikat", u"<b>onClosePlugin</b>")
    ...
    def unload(self):
        #QMessageBox.warning( self.iface.mainWindow(),"Komunikat", u"<b>unload</b>")
    ...
    def run(self):
        #QMessageBox.warning( self.iface.mainWindow(),"Komunikat", u"<b>run</b>")
...
#---------------------------------------------------------------------------
    ...
    def handleMouseDown(self, mouseEvent):
        ...
        if ToolMode == 'GPX':
            ...
            global ActualFotoID
            #if ActualFotoID != -99: self.SetFotopulapka(ActualFotoID)
